...
import com.eazybytes.homeStayApp.service.ContactService;
...
public class ContactController {
    ...
    public String saveMessage(@Valid @ModelAttribute("contact") Contact contact, Errors errors){
        if(errors.hasErrors()){
            log.info("contact creation failed due to {}", errors.toString());
            return "contact.html";
        }
    ...
    public ModelAndView displayMessages(Model model, @PathVariable(name = "pageNum") int pageNum,
        ...
        Page<Contact> contactMsgPage=contactService.findMsgsWithOpenStatus(pageNum,sortField,sortDir);

        List<Contact> contactMessages=contactMsgPage.getContent();
        ModelAndView modelAndView = new ModelAndView("messages.html");
        model.addAttribute("currentPage", pageNum);
        model.addAttribute("totalPages", contactMsgPage.getTotalPages());
        model.addAttribute("totalMsgs", contactMsgPage.getTotalElements());
